...
// Cargar las secciones desde archivos externos
document.addEventListener('DOMContentLoaded', () => {
    loadContent('artropodos/insectos.html', 'insectos-section');
    loadContent('artropodos/aracnidos.html', 'aracnidos-section');
    loadContent('artropodos/crustaceos.html', 'crustaceos-section');
    loadContent('artropodos/miriapodos.html', 'miriapodos-section');

    loadContent('mamiferos/roedores.html', 'roedores-section');
    loadContent('mamiferos/carnivoros.html', 'carnivoros-section');
    loadContent('mamiferos/marsupial.html', 'primates-section');
    loadContent('mamiferos/insectivoros.html', 'insectivoros-section');
});